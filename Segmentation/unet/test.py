...
def cal_miou(test_dir="unet/data/Test_Images",
             pred_dir="unet/data/results", gt_dir="unet/data/Test_Labels"):
    # ---------------------------------------------------------------------------#
    ...
    # --------------------------------------------#
    name_classes = ["background", "fossil"]
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            save_path=image_path.replace('unet/data/Test_Images','unet/data/results').replace('.jpg','.png')
            

            cv2.imwrite(save_path,pred)

            #visualize.display_instance(img, pred['rois'], pred['masks'], pred['class_ids'], class_names,file_path, pred['scores'])
